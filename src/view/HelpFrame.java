...
public class HelpFrame extends JFrame {
	...
	public HelpFrame() {
		...
		tekst.setText("Deo projekta pripremljen za prvu kontrolnu tacku.\r\n" + 
				"Odradjena vizuelizacija glavnog prozora, njegovih toolbar i main menu komponenti, statusna traka(koja se sastoji iz text labele i date formata)\r\n" + 
				"Na glavni prozor je dodat tabPane koji se sastoji iz 3 taba na kojima ce biti dodate tabele \r \n \n" +
